                ...
                >
                    ...
                    <div style={{padding: '15px 25px', width: '650px'}}>
                        ...
                        <Grid container>
                            ...
                            <Grid container>
                                <FormField2 label="Problem Abstract"
                        ...
                        <Button variant="contained" color="secondary" style={{height: 20}}
                                onClick={() => {
                                    this.props.setSelectedTicket(
                                        Object.assign({}, this.props.ccopyTicket.ticket, {"ticket_number": this.props.selectedTicket.ticket_number}
                                        ))
                                }}>Copy All
                        </Button>
                    </div>
